...
- [**How to use LogAider**](#3)
	...
	- [**2. Across-Field correlation**](#3.2)
		- [Analysis based on RAS Log](#3.2.1)
			...
			- [Generate analysis for inputMsg.txt](#3.2.1.5)
			- [Generate spatial distribution (to be plotted in a graph by plot.PlotMiraGraph later on)](#3.2.1.6)
		- [Analysis based on job scheduling log (Cobalt)](#3.2.2)
			...
			- [Calculate the number of value combinations by brute-force method](#3.2.2.3)
			- [Generate analysis for inputMsg.txt](#3.2.2.4)
			- [Generate error distribution](#3.2.2.5)
	...
	- [**6. Analyze the error propagation**](#3.6)
		- [Analyze the error propagation (with the same type)](#3.6.1)
		- [Similarity-based Event Filter](#3.6.2)
...
### <a id="3.6"/>6. Analyze the error propagation</a>
...
- <a id="3.6.2"/>**Similarity-based Temporal Error Propagation Analysis (Similarity-based Event Filter)**</a>
	- *Script*: -
...
> *[allEventsFile]* is a file that was generated by the previous [filter.TemporalSpatialFilter](#3.1.1.3)  
...
> output: We have put the example output files in the sub-directory: similarity-based-filter. Please read the [README.txt](example-output/similarity-based-filter/README.txt) in that folder to understand the results.
