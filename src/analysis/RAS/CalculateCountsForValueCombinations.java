...
public class CalculateCountsForValueCombinations {
	...
	public static void main(String[] args) {
		...
		if (args.length < 6) {
			...
			System.out
					.println("Example: java CalculateCountsForValueCombinations /home/fti/Catalog-project/miralog/schema/basicSchema2.txt /home/fti/Catalog-project/miralog/schema/fullSchema/withRatio fsr /home/fti/Catalog-project/miralog csvtmp "
							+ "/home/fti/Catalog-project/miralog/fieldValueCombination CATEGORY COMPONENT CTLACTION MSG_ID SEVERITY TEMPLATE");
			System.exit(0);
		}
	...
	public static void analyzeMessage(String line)
	{
		...
		//4 items
		for(int i = 0;i<fieldIndex.length-3;i++)
			for(int j = i+1;j<fieldIndex.length-2;j++)
		...
		//5 items
		for(int i = 0;i<fieldIndex.length-4;i++)
			for(int j = i+1;j<fieldIndex.length-3;j++)
