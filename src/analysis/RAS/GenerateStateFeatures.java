...
public class GenerateStateFeatures {
	public static void main(String[] args)
	{
		if(args.length<8)
		{
			...
			System.out.println("Example: java GenerateStateFeatures /home/fti/Catalog-project/miralog/schema/basicSchema.txt /home/fti/Catalog-project/miralog/schema/fullSchema/withCount fsc "
					+ "/home/fti/Catalog-project/miralog csvtmp(or csv) /home/fti/Catalog-project/miralog/featureState"
					+ " CATEGORY COMPONENT CPU CTLACTION LOCATION MSG_ID SEVERITY");
			System.exit(0);
		}
...
//				{
//					System.out.println("stateIndexMap==null: stateValue="+stateValue);
//					System.exit(0);
//				}
				int stateRecordIndex = stateIndexMap.get(stateValue);
//				if(stateRecordIndex==null)
//				{
//					System.out.println("stateRecordIndex==null: stateValue="+stateValue);
//					System.exit(0);
//				}
