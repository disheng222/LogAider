...
public class ChiSquareBatchTest {

	public static float[] alpha = {0.001f, 0.002f, 0.005f, 0.01f, 0.02f, 0.025f, 0.05f, 0.01f, 0.02f};
	...
	public static void main(String[] args)
	{
		...
		List<String> dirList = PVFile.getDir(contingTableDirPath);
		Iterator<String> iter = dirList.iterator();
		while(iter.hasNext())
		{
			String dir = iter.next();
			String dirPath = contingTableDirPath+"/"+dir;
			String outputFile = outputDir+"/"+dir+".ctst";
			processOneContingTableDir(dirPath, extension, outputFile);
		}
