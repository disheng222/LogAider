...
public class GnuplotDistribution {
	...
	public static List<String> genDistribution(double[] rawData, int scale)
	{
		int m = rawData.length;
		int distrIntervals = scale;
		...
		ConversionHandler.convertArray2List4Comp(distResult, resultList, minmax[0], unit);
...
//				break;
		...
		if(max>upperBound)
			max = upperBound;
		if(GnuplotComputeDistribution.maxValue<0)
